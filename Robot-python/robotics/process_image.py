...
from perspect_transofrm import perspect_transofrm
...
def process_image(img):
    ...
    warped, mask = perspect_transofrm(img, source, destination)

    # Apply Color threshold to identity navigable terrain/obstacles/rock sample
    threshed = color_threshold(warped)
    ...
    obs_x_world, obs_y_world = pix_to_world(obsxpix, obsypix, xpos, ypos, yawm world_size, scale)
